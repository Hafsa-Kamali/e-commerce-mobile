...
const Banner = () => {
  return (
    <section className="w-full md:w-[1550px] h-full md:h-[632px] bg-gray-900 text-white flex flex-col md:flex-row md:items-center">
    ...
    <div className="relative flex justify-center md:ml-[22rem] mt-8 md:mt-0">
      <Image
        ...
        width={406}
        height={632}
        className="w-[90%] md:w-[100%] h-[632px]"
      />
    </div>
  </section>
