    ...
    <div className="w-full h-auto lg:h-[600px] bg-green-300 flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-[720px] flex flex-col">
        ...
        <div className="w-full h-auto lg:h-[328px] bg-white overflow-hidden flex flex-col lg:flex-row items-center">
          <Image
            className="w-[80%] lg:w-[360px] h-auto mx-auto hidden lg:flex"
          ...
          <div className="p-4 w-full lg:w-[338px] grid text-center lg:text-left">
            ...
            <p className="text-[20px] lg:text-[16px] text-[#909090] sm:w-[85%] lg:w-full">
...
<Image
            ...
            <div className="p-4 grid text-center lg:text-left">
              ...
              <p className="text-[20px] lg:text-[14px] text-[#909090] font-medium">
      ...
      <div className="w-full lg:w-[850px] h-auto bg-[#EDEDED] py-8 lg:flex lg:items-center lg:justify-between">
      <Image
        ...
        <Image
          className="w-[80%] lg:w-[292px] h-auto mx-auto lg:m-0 lg:mr-8 hidden lg:flex"
          src={MacBook}
          alt="Macbook"
        />
      </div>
