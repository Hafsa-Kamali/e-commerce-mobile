...
export default function Products() {
  return (
    <div className="w-[420px] lg:w-[1440px] px-2 lg:px-[160px] py-[56px] items-center justify-center">
      {/* Categories */}
      <div className="lg:w-full w-[80%] flex ml-[6rem] lg:ml-0 text-[#8b8b8b] gap-x-4">
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4  gap-2 lg:gap-4">
        {products.map((product, index) => (
          <div key={index} className="w-[200px] md:w-full h-[400px] lg:h-[450px] gap-4 md:gap-6 px-8 py-6 md:px-4 md:py-6 bg-[#f6f6f6] rounded-[9px] ml-[5rem] lg:ml-0">
