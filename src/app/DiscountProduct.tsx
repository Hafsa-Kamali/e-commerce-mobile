    ...
    export default function DiscountProducts() {
      return (
        <div className="w-[500px] lg:w-[1440px] px-4 lg:px-[160px] py-[56px] items-center justify-center mt-[120rem] md:mt-0">
            <div>
                <h2 className="text-3xl items-center justify-center">Discounts up to -50%</h2>
            </div>
          {/* Products Grid */}
          <div className="mt-8 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {products.map((product, index) => (
              <div key={index} className="w-[230px] md:w-full h-[432px] gap-x-4 md:gap-0 px-8 py-6 md:px-4 md:py-6 bg-[#f6f6f6] rounded-[9px]">
